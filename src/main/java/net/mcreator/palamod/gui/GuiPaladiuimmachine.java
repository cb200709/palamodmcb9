...
public class GuiPaladiuimmachine extends ElementsPalamodMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiPaladiuimmachine(ElementsPalamodMod instance) {
		super(instance, 200);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 23, 20) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 156, 21) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 41, 37) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 137, 38) {
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 92, 60) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("palamod_:textures/paladiuimmachine.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("palamod_:textures/fleche.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + -342, this.guiTop + -321, 0, 0, 128, 1408, 128, 1408);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Paladium machine", 56, 11, -65485);
			this.fontRenderer.drawString("wait", 67, 61, -256);
			this.fontRenderer.drawString("wait", 110, 62, -256);
		}
		...
		protected void actionPerformed(GuiButton button) {
			PalamodMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
