...
public class BlockJacarandaslab extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:jacarandaslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("palamod_:jacarandaslab_double")
	public static final Block block_slab_double = null;
	public BlockJacarandaslab(ElementsPalamodMod instance) {
		super(instance, 23);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("jacarandaslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("jacarandaslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("palamod_:jacarandaslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("jacarandaslab");
