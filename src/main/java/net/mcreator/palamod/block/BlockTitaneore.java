...
public class BlockTitaneore extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:titaneore")
	public static final Block block = null;
	public BlockTitaneore(ElementsPalamodMod instance) {
		super(instance, 3);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("titaneore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("palamod_:titaneore", "inventory"));
	}
