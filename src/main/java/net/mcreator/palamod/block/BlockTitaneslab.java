...
public class BlockTitaneslab extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:titaneslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("palamod_:titaneslab_double")
	public static final Block block_slab_double = null;
	public BlockTitaneslab(ElementsPalamodMod instance) {
		super(instance, 48);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("titaneslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("titaneslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("palamod_:titaneslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("titaneslab");
