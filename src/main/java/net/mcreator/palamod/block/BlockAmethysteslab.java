...
public class BlockAmethysteslab extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:amethysteslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("palamod_:amethysteslab_double")
	public static final Block block_slab_double = null;
	public BlockAmethysteslab(ElementsPalamodMod instance) {
		super(instance, 13);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amethysteslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("amethysteslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("palamod_:amethysteslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("amethysteslab");
