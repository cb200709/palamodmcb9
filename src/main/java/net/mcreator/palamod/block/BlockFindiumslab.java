...
public class BlockFindiumslab extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:findiumslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("palamod_:findiumslab_double")
	public static final Block block_slab_double = null;
	public BlockFindiumslab(ElementsPalamodMod instance) {
		super(instance, 81);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("findiumslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("findiumslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("palamod_:findiumslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("findiumslab");
