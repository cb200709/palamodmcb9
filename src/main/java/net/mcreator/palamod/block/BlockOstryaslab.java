...
public class BlockOstryaslab extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:ostryaslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("palamod_:ostryaslab_double")
	public static final Block block_slab_double = null;
	public BlockOstryaslab(ElementsPalamodMod instance) {
		super(instance, 65);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ostryaslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("ostryaslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("palamod_:ostryaslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("ostryaslab");
