...
public class BlockAmethysteore extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:amethysteore")
	public static final Block block = null;
	public BlockAmethysteore(ElementsPalamodMod instance) {
		super(instance, 2);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("amethysteore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("palamod_:amethysteore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("amethysteore");
