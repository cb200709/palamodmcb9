...
public class BlockGreenpaladiumslab extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:greenpaladiumslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("palamod_:greenpaladiumslab_double")
	public static final Block block_slab_double = null;
	public BlockGreenpaladiumslab(ElementsPalamodMod instance) {
		super(instance, 70);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("greenpaladiumslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("greenpaladiumslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("palamod_:greenpaladiumslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("greenpaladiumslab");
