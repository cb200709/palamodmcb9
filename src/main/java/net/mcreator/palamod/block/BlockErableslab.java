...
public class BlockErableslab extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:erableslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("palamod_:erableslab_double")
	public static final Block block_slab_double = null;
	public BlockErableslab(ElementsPalamodMod instance) {
		super(instance, 27);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("erableslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("erableslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("palamod_:erableslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("erableslab");
