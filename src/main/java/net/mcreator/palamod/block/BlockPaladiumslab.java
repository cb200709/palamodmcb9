...
public class BlockPaladiumslab extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:paladiumslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("palamod_:paladiumslab_double")
	public static final Block block_slab_double = null;
	public BlockPaladiumslab(ElementsPalamodMod instance) {
		super(instance, 11);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("paladiumslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("paladiumslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("palamod_:paladiumslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("paladiumslab");
