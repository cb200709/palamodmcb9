...
public class BlockFindiumore extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:findiumore")
	public static final Block block = null;
	public BlockFindiumore(ElementsPalamodMod instance) {
		super(instance, 6);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("findiumore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("palamod_:findiumore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemFindium.block, (int) (1)));
		}
