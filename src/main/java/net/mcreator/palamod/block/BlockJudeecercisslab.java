...
public class BlockJudeecercisslab extends ElementsPalamodMod.ModElement {
	@GameRegistry.ObjectHolder("palamod_:judeecercisslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("palamod_:judeecercisslab_double")
	public static final Block block_slab_double = null;
	public BlockJudeecercisslab(ElementsPalamodMod instance) {
		super(instance, 25);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("judeecercisslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("judeecercisslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("palamod_:judeecercisslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("judeecercisslab");
