...
public class ProcedurePaladiuimmachineWhileThisGUIIsOpenTick extends ElementsPalamodMod.ModElement {
	public ProcedurePaladiuimmachineWhileThisGUIIsOpenTick(ElementsPalamodMod instance) {
		super(instance, 202);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure PaladiuimmachineWhileThisGUIIsOpenTick!");
			return;
		}
